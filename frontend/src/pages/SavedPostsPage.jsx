...
const SavedPostsPage = () => {
  ...
  return (
    <div>
      {/* Header */}
      <div className="bg-mono-white dark:bg-mono-900 rounded-lg border border-mono-300 dark:border-mono-800 p-4 mb-4 shadow-mono">
        <div className="flex items-center gap-2">
          <Bookmark className="w-6 h-6 text-mono-black dark:text-mono-white" />
          <h1 className="text-2xl font-bold text-mono-black dark:text-mono-white">
            Saved Posts
          </h1>
        </div>
        <p className="text-mono-600 dark:text-mono-500 text-sm mt-1">
      ...
      {savedPosts.length === 0 ? (
        <div className="bg-mono-white dark:bg-mono-900 rounded-lg border border-mono-300 dark:border-mono-800 p-8 text-center">
          ...
          <p className="text-mono-black dark:text-mono-white mb-2">
            No saved posts yet
          </p>
